...
public class Bloc5_31 {
    ...
    public static void main(String[] args) {
        ...
        //Determinar quin és el venedor que més unitats ha venut
        for (i = 0; i < Ven; i++) {
            suma = 0;
            for (j = 0; j < Prod; j++) {
        ...
        System.out.printf("\n\nEl venedor que ha tingut més vendes és el %d amb %d unitats\n", vend_maxim, maxim);

        //Determinar quin és el producte més venut
        maxim = -1;
        for (j = 0; j < Prod; j++) {
            suma = 0;
            for (i = 0; i < Ven; i++) {
        ...
        System.out.printf("\n\nEl producte més venut és el %d amb %d unitats\n", prod_maxim, maxim);

        //Donat un número de producte introduït per teclat, determinar quantes unitats se n’han venut per tots els venedors.
        System.out.printf("\nQuin producte vols que calculem ?");
        producte = in.nextInt();
        suma = 0;
        for (i = 0; i < Ven; i++) {
//            suma = suma + vendes[i][producte];
